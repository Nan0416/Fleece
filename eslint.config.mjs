...
export default tseslint.config(
  ...
  },
  {
    ...
    // caller.
    files: ['packages/shared/src/api/*.ts', 'packages/core/src/data/*-dao.ts', 'packages/core/src/services/*.ts', 'packages/broker/src/alpaca/alpaca-rest-client.ts', 'packages/broker/src/l1/*.ts'],
